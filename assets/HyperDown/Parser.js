...
// (function() {
  ...
  Parser = (function() {
    ...
    Parser.prototype.parseList = function(lines) {
      var found, html, j, key, l, lastType, leftLines, len, len1, len2, line, m, matches, minSpace, row, rows, secondMinSpace, space, text, type, row_types, check_type, __count;
      html = '';
      minSpace = 99999;
      rows = [];
        ...
        if (row instanceof Array) {
          ...
          if (space !== minSpace) {
            ...
            if (leftLines.length > 0) {
              let _html = this.parse(leftLines.join("\n"));
    ...
    Parser.prototype.getFaceUrl = function (alt) {
      ...
      return idx > -1 ? "/static/images/face/" + idx + ".gif" : "";
    };
